# Assessment 3 - Modelling responses to climate change {#A3A_1 .unnumbered}
...
### Model Overview {#A3A_3 .unnumbered}
...
### Exercises {#A3A_5 .unnumbered}

#### Building the model {#A3A_6 .unnumbered}

1)  Draw by hand the conceptual model of this system.
2)  Confirm with the person beside you what index means ($t$, $i$, $p$).
3)  Build the above model to predict the individual sub catchment flows and basin total flow. Assume basic information as outlined in Table \@ref(tab:tableA3A1) below and supplied rainfall data for the 3 catchments. Input a value for $c$ within the range given for now.
...
#### Calculate phosphate concentrations {#A3A_8 .unnumbered}
...
#### Consider 2 management scenarios {#A3A_9 .unnumbered}
