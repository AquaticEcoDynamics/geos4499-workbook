...
should use in your calculations.
...
+-----------+-------+-----------+-----------+-----------+-----------+
| **Site**  | **    | **Section | **Depth   | **Width   |**Velocity |
|           | Total |    (m)**  |   (m)**   |   (m)**   |(m s^-1^)**|
|           | width |           |           |           |           |
|           | (m)** |           |           |           |           |
|           |       |           |           |           |           |
...
: Measured data for velocity-area method of calculating streamfllow
...
Western Australia (near Pemberton). Sketch the geometry of one of these
cross-sections and calculate the total area and wetted perimeter. Use
the slope over the 5.2 km of Carey Bk between the main highway (25 m
AHD) and where it flows into the Donnelly River (7 m AHD). Now you just
need a roughness parameter, Manning's $n$, and you can solve Equation
\@ref(eq:exercise2-2).
